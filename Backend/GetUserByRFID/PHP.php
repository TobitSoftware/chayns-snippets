...
$user = GetUserByRFID($_GET['locationId'],$_GET['tappId'], $_GET['RfidData']);
if($user != null) {
...
function GetUserByRFID($locationId, $RfidData) {

  //Build the request
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,Server.'/'.$locationId.'/User?rfid='.$RfidData);
